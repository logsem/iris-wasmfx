...
From Wasm.iris.logrel Require Export iris_fundamental_helpers iris_interp_instance_alloc.
Require Export stack_instantiation_interp.
...
Section RobustStack.
  ...
  Proof.
    ...
    rewrite lookup_drop Nat.add_comm Nat.sub_add //.
