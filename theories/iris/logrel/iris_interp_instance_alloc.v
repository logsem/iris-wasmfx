...
Require Export iris_fundamental.
...
Section InterpInstance.
 ...
 Qed.
  ...
  Lemma module_import_init_tabs_dom m i wts :
    dom (D := gset N) (module_import_init_tabs m i wts) = dom (D := gset N) wts.
  Proof.
    unfold module_import_init_tabs.
    apply fold_left_preserve;auto.
    intros tt me Hdom.
  ...
  Lemma module_import_init_mems_dom m i wts :
    dom (D := gset N) (module_import_init_mems m i wts) = dom (D := gset N) wts.
  Proof.
    unfold module_import_init_mems.
    apply fold_left_preserve;auto.
    intros tt me Hdom.
