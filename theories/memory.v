...
Definition length_mem_t Mem_t := Mem_t -> N.
...
Definition mem_ax_lookup_out_of_bounds
  ...
  (length_mem : length_mem_t Mem_t)
  (mem_grow : mem_grow_t Mem_t)
  (mem_lookup : mem_lookup_t Mem_t)
  (mem_update : mem_update_t Mem_t) :=
  forall mem i, N.ge i (length_mem mem) -> mem_lookup i mem = None.
...
Definition mem_ax_lookup_update
  ...
  (mem_lookup : mem_lookup_t Mem_t)
  (mem_update : mem_update_t Mem_t) :=
  forall mem mem' i b, N.lt i (length_mem mem) -> Some mem' = mem_update i b mem -> mem_lookup i mem' = Some b.
...
Definition mem_ax_length_constant_update
  ...
  (mem_lookup : mem_lookup_t Mem_t)
  (mem_update : mem_update_t Mem_t) :=
  forall i b mem mem', Some mem' = mem_update i b mem -> length_mem mem' = length_mem mem.
...
Record mixin_of (Mem_t : Type) : Type := Mixin {
  ...
  _ : mem_ax_lookup_out_of_bounds Mem_t mem_make length_mem mem_grow mem_lookup mem_update;
  _ : mem_ax_lookup_make Mem_t mem_make length_mem mem_grow mem_lookup mem_update;
  _ : mem_ax_lookup_update Mem_t mem_make length_mem mem_grow mem_lookup mem_update;
  _ : mem_ax_lookup_skip Mem_t mem_make length_mem mem_grow mem_lookup mem_update;
  _ : mem_ax_length_constant_update Mem_t mem_make length_mem mem_grow mem_lookup mem_update;
}.
